...
creator_id | integer | Unique identifier of the User this Time Off/Downtime event was created by. **(DEPRECATED: Future versions of the API will not include this field)**
